...
# Blank install script for xarray 0.12
pip install aiobotocore boto3 bottleneck cartopy cdms2 cfgrib cftime dask distributed h5netcdf h5py hdf5 hypothesis iris lxml matplotlib-base nc-time-axis netcdf4 numba numexpr numpy pandas pint pooch pre-commit pseudonetcdf pydap pytest pytest-cov pytest-env pytest-xdist rasterio scipy seaborn setuptools sparse toolz zarr numbagg
